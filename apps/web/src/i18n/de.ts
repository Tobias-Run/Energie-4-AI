...
export const de: typeof en = {
  ...
  levers: {
    ...
    demandEmberNote:
      'Grundlage sämtlicher veröffentlichter Zahlen in diesem Repository. Die EU-27-Nachfrage wächst um rund 0,85 %/Jahr und liegt damit nahe am Nenner, den Embers Rechenzentrums-Anteilsanker implizieren (~2.490 TWh in 2030). Die dahinterliegenden Länderraten sind expert-guess-Gerüst; der Name steht für die Lesart, zu der sie passen, nicht für eine Herleitung (Issue #68). Er bleibt bewusst als offene Frage der Standard, nicht als entschiedene: Keine der beiden Lesarten ist sauber, und welcher Autorität ein europäischer Nachfrage-Nenner folgen sollte, hat dieses Projekt einem externen Gutachter vorgelegt, statt es selbst zu entscheiden.',
