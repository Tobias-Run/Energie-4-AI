...
export const en = {
  ...
  levers: {
    ...
    demandEmberNote:
      'What every published figure in this repository is computed on. EU-27 demand grows about 0.85%/yr, which sits near the denominator Ember’s data-centre share anchors imply (~2,490 TWh in 2030). The per-country rates behind it are expert-guess scaffolding, named for the reading they agree with rather than derived from it (issue #68). It stays the default as a deliberate open question, not a settled one: neither reading is clean, and which authority a European demand denominator should follow is a judgement this project has put to an external reviewer rather than made for itself.',
